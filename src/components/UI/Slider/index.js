            ...
            <button className={styles.rightButton} onClick={()=>getNextSlide()}>
                <svg width="58" height="60" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g clip-path="url(#clip0_12_88)">
                        ...
                        <path d="M17.6359 24.2119V30.788" stroke="white" stroke-width="1.75" stroke-linecap="round" strokeLinejoin="round"/>
                        <path d="M20.9239 24.2119V30.788" stroke="white" stroke-width="1.75" stroke-linecap="round" strokeLinejoin="round"/>
                    </g>
                    <defs>
